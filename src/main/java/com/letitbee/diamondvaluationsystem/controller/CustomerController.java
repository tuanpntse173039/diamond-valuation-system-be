...
public class CustomerController {
    ...
    @GetMapping
    public ResponseEntity<Response<CustomerNoRequestDTO>> getAllCustomer(@RequestParam(name = "pageNo", defaultValue = AppConstraint.PAGE_NO, required = false) int pageNo,
